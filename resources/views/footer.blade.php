...
<div class="footer helvelthica" id="footer" align ="center" style="margin-top: 10%">

<span><p style="font-size: 2em;margin-top:1%"><img  src="{{asset('image/lo.png')}}" style="width: 3.5%">&nbsp&nbspBy Wash's Easy Co.,Ltd. </p></span>
<hr  style="width:60%">
<div align="center">
